                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <select class="form-control" name="item[]">
                                                ...
                                                <option value="<?php echo $res['idItemNamaUkuran']; ?>">
                                                    <?php echo $res['namaUkuran']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-2">
                                            <button type="button" class="btn mb-1 btn-rounded btn-primary mt-2"
                                                name="add" id="add"><i class="ti-plus"></i></button>
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="form-group row">
...
$(document).ready(function() {
    ...
    $('#add').click(function() {
        i++;
        $('#formUkuran').append('<div class="form-group row" id="baris' + i +
            '"><label class="col-lg-4 col-form-label" for="val-username"></label><div class="col-lg-4"><select class="form-control" id="val-skill" name="item[]">' +
            '<option value="">Pilih Nama Item</option>' +
            '<?php $kueri = mysqli_query($koneksi, "SELECT * FROM tbl_itemNamaUkuran");
                    while ($res = mysqli_fetch_array($kueri)) { ?>' +
            ...
            '</div>' +
            '<div class="col-lg-2">' +
            '<button type="button" class="btn mb-1 btn-rounded btn-danger mt-2 remove" name="remove" id="' +
            i + '"><i class="ti-minus"></i></button>' +
            '</div></div>');
    });
