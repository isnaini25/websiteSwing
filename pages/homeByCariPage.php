        ...
        <div class="item-penjahit">
            <form action="homeByCari.php" class="cari" method="POST">
                <div class="form-group col-sm-6">
                 <?php if(isset($_POST['cari'])){
                    ...
                    <input class="form-control" type="text" placeholder="Cari penjahit.." name="cari" value="<?php echo $q;?>">
                </div>
                    ...
                    <div class="filter">
                        ...
                        ?>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="kat[]" value="<?php echo $resKat['idKategori']; ?>" <?php if (isset($_POST['kat'])) {
                                    if (in_array($resKat['idKategori'], $kats)) {
                                        echo 'checked';
                                    }
                                }?>>
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    ...
                    $kueri = mysqli_query($koneksi, "SELECT * FROM tbl_penjahit WHERE  nama LIKE '%$q%'AND statusAktif = 1 LIMIT 12  ");
