        ...
        <div class="item-penjahit">
                    ...
                    <div class="filter">
                        ...
                        ?>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="kat[]" value="<?php echo $resKat['idKategori']; ?>">
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    ...
                    $kueri = mysqli_query($koneksi, "SELECT * FROM tbl_penjahit WHERE statusAktif = 1 LIMIT 12 ");
