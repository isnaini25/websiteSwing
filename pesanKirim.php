...
if(isset($_POST['pesan'])){
    ...
    if($rowPesan>0){
        ...
        $queryUpdate = mysqli_query($koneksi, "UPDATE tbl_pesan SET waktuTerakhir = '$waktu', status=0 WHERE idPesan = '$idPesan'");
    }else{
        $query = mysqli_query($koneksi, "INSERT INTO tbl_pesan (idPelanggan, idPenjahit, status, waktuTerakhir) values
         ('$idPelanggan','$idPenjahit', 0, '$waktu')");
